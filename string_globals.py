...
import os
npz_root='../../../../../scratch/jlb638/imgs_npz' #where the npz matrices are
img_dir='../../../../../scratch/jlb638/images' #where the actual images themselves are
...
checkpoint_dir='../../../../../scratch/jlb638/checkpoints' #where saved models are stored
